...
export const projects = [
  {
    ...
    description: `A web application developed as part of 
    my thesis project to enhance document tracking across the 13 External Studies Unit (ESU) campuses of WMSU. 
    Utilizing Model 2 QR Code technology, the system ensures efficient monitoring of document submissions, 
    tracing their movement from faculty members to key administrative offices. By providing real-time 
